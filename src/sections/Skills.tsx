...
export const Skills = () => {
    ...
    return (
        <section id="skills" className="py-20 px-4 bg-experience">
            <div className="container mx-auto">
                <div className="text-center mb-10">
                    <h2 className="text-4xl md:text-5xl font-bold mb-4">{t('skills.title')}</h2>
                    <p className="text-xl text-grey">{t('skills.subtitle')}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    {categories.map((category, index) => (
                        <Card
                            key={category}
                            className="p-6 hover-lift animate-slide-up bg-base border-2 border-base-inv"
